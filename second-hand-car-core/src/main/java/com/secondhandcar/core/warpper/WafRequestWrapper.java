package com.secondhandcar.core.warpper;

import com.secondhandcar.core.utils.FireWallUtils;
...
public class WafRequestWrapper extends HttpServletRequestWrapper {
	...
	protected String filterParamString(String rawValue) {
		...
		if (this.filterXSS) {
			tmpStr = FireWallUtils.stripXSS(rawValue);
		}
		if (this.filterSQL) {
			tmpStr = FireWallUtils.stripSqlInjection(tmpStr);
		}
		return tmpStr;
	}
}