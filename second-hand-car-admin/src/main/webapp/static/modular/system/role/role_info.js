...
RolInfoDlg.showDeptSelectTree = function () {
    SecondHandCarAdmin.showInputTree("deptName", "deptContent");
};
...
RolInfoDlg.showPNameSelectTree = function () {
    SecondHandCarAdmin.showInputTree("pName", "pNameContent");
};
...
RolInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/role/add", function (data) {
...
RolInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/role/edit", function (data) {
...
$(function () {
    SecondHandCarAdmin.initValidator("roleInfoForm", RolInfoDlg.validateFields);
