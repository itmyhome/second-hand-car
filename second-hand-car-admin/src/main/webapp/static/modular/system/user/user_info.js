...
UserInfoDlg.addSubmit = function () {
    ...
    if (!this.validatePwd()) {
        SecondHandCarAdmin.error("两次密码输入不一致");
        return;
    }

    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/user/add", function (data) {
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/user/edit", function (data) {
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/user/changePwd", function (data) {
        SecondHandCarAdmin.success("修改成功!");
    }, function (data) {
        SecondHandCarAdmin.error("修改失败!" + data.responseJSON.message + "!");
    });
...
$(function () {
    SecondHandCarAdmin.initValidator("userInfoForm", UserInfoDlg.validateFields);
