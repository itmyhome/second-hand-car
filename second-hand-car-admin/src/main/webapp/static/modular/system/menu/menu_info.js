...
MenuInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/menu/add", function (data) {
...
MenuInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/menu/edit", function (data) {
...
MenuInfoDlg.showMenuSelectTree = function () {
    SecondHandCarAdmin.showInputTree("pcodeName", "pcodeTreeDiv", 15, 34);
};

$(function () {
    SecondHandCarAdmin.initValidator("menuInfoForm", MenuInfoDlg.validateFields);
