...
NoticeInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/notice/add", function (data) {
...
NoticeInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/notice/update", function (data) {
...
$(function () {
    SecondHandCarAdmin.initValidator("noticeInfoForm", NoticeInfoDlg.validateFields);
