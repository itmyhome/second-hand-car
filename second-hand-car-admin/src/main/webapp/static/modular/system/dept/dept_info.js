...
DeptInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/dept/add", function(data){
...
DeptInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/dept/update", function(data){
...
$(function() {
    SecondHandCarAdmin.initValidator("deptInfoForm", DeptInfoDlg.validateFields);
