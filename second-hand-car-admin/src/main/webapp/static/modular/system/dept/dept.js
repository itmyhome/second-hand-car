...
Dept.openAddDept = function () {
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: SecondHandCarAdmin.ctxPath + '/dept/dept_add'
    });
...
Dept.openDeptDetail = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: SecondHandCarAdmin.ctxPath + '/dept/dept_update/' + Dept.seItem.id
        });
        this.layerIndex = index;
    }
};
...
Dept.delete = function () {
    if (this.check()) {
        ...
        var operation = function(){
            var ajax = new $ax(SecondHandCarAdmin.ctxPath + "/dept/delete", function () {
        ...
        SecondHandCarAdmin.confirm("是否刪除该部门?", operation);
    }
};
