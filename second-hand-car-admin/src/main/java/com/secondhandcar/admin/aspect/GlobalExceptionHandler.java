...
//        HttpUtils.getRequest().setAttribute("tip", e.getMessage());
//        log.error("业务异常:", e);
...
//    }
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ResponseBody
    public ReturnResult credentials(UndeclaredThrowableException e) {
        log.error("权限异常!", e);
        return new ReturnResult(BizExceptionEnum.NO_PERMITION.getCode(),BizExceptionEnum.NO_PERMITION.getMessage());
    }
