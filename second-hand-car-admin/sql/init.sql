...
Source Database       : second_hand_car

Target Server Type    : MYSQL
Target Server Version : 50621
File Encoding         : 65001

Date: 2017-10-11 22:39:28
*/
...
INSERT INTO `menu` VALUES ('106', 'user', 'system', '[0],[system],', '用户管理', '', '/user', '1', '2', '1', null, '1', '0');
INSERT INTO `menu` VALUES ('107', 'user_add', 'user', '[0],[system],[user],', '添加用户', null, '/user/add', '1', '3', '0', null, '1', '0');
INSERT INTO `menu` VALUES ('108', 'user_edit', 'user', '[0],[system],[user],', '修改用户', null, '/user/edit', '2', '3', '0', null, '1', '0');
INSERT INTO `menu` VALUES ('109', 'user_delete', 'user', '[0],[system],[user],', '删除用户', null, '/user/delete', '3', '3', '0', null, '1', '0');
INSERT INTO `menu` VALUES ('110', 'user_reset', 'user', '[0],[system],[user],', '重置密码', null, '/user/reset', '4', '3', '0', null, '1', '0');
INSERT INTO `menu` VALUES ('111', 'user_freeze', 'user', '[0],[system],[user],', '冻结用户', null, '/user/freeze', '5', '3', '0', null, '1', '0');
INSERT INTO `menu` VALUES ('112', 'user_unfreeze', 'user', '[0],[system],[user],', '解除冻结用户', null, '/user/unfreeze', '6', '3', '0', null, '1', '0');
INSERT INTO `menu` VALUES ('113', 'user_setRole', 'user', '[0],[system],[user],', '分配角色', null, '/user/setRole', '7', '3', '0', null, '1', '0');
...
INSERT INTO `menu` VALUES ('149', 'api_user', '0', '[0],', '接口文档', 'fa-leaf', '/swagger-ui.html', '2', '1', '1', null, '1', null);
...
INSERT INTO `menu` VALUES ('165', 'to_assign_role', 'user', '[0],[system],[user],', '分配角色跳转', '', '/user/role_assign', '8', '3', '0', null, '1', null);
INSERT INTO `menu` VALUES ('166', 'to_user_edit', 'user', '[0],[system],[user],', '编辑用户跳转', '', '/user/user_edit', '9', '3', '0', null, '1', null);
INSERT INTO `menu` VALUES ('167', 'user_list', 'user', '[0],[system],[user],', '用户列表', '', '/user/list', '10', '3', '0', null, '1', null);
...
INSERT INTO `operation_log` VALUES ('482', '业务日志', '修改菜单', '1', 'com.stylefeng.guns.modular.system.controller.MenuController', 'edit', '2017-06-04 10:22:58', '成功', '菜单名称=分配角色跳转;;;字段名称:url地址,旧值:/role/role_assign,新值:/user/role_assign');
